        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#111827;border:1px solid rgba(59,130,246,0.18);border-radius:14px;overflow:hidden;">
          ...
          <tr>
            <td style="background:#0A0A0A;border-top:1px solid rgba(255,255,255,0.05);padding:20px 40px;text-align:center;">
              <p style="margin:0 0 6px;font-size:11px;color:#3f3f46;letter-spacing:1px;text-transform:uppercase;">Aurevon Labs &middot; ${process.env.COMPANY_ADDRESS || 'aurevongroup.com'}</p>
              <p style="margin:0;font-size:11px;color:#3f3f46;">
                You received this because you completed a purchase on aurevongroup.com.
              </p>
            </td>
          </tr>
...
---
Aurevon Labs · ${process.env.COMPANY_ADDRESS || 'aurevongroup.com'}
You received this because you completed a purchase on aurevongroup.com.
`;
}
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0A0A0A;padding:40px 16px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#111827;border:1px solid rgba(59,130,246,0.18);border-radius:14px;overflow:hidden;">
        ...
        <tr>
          <td style="background:#0A0A0A;border-top:1px solid rgba(255,255,255,0.05);padding:20px 40px;text-align:center;">
            <p style="margin:0;font-size:11px;color:#3f3f46;">Aurevon Labs &middot; ${process.env.COMPANY_ADDRESS || 'aurevongroup.com'}</p>
          </td>
        </tr>
      </table>
    </td></tr>
